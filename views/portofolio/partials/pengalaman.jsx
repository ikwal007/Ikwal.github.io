        ...
        <ul className="max-w-md mx-auto mt-16 space-y-12">
          <li className="relative flex items-start">
            ...
            <div className="relative flex items-center justify-center flex-shrink-0 w-16 h-16 bg-white rounded-full shadow">
              <FaUserSecret className="w-10 h-10 text-fuchsia-600" />
            </div>
            <div className="ml-6">
              <h3 className="text-lg font-semibold text-black">Magang</h3>
              <p className="mt-4 text-base text-gray-600">
                Pada tahun 2018, saya mengikuti magang selama 3 bulan di Yayasan
          ...
          <li className="relative flex items-start">
            ...
            <div className="ml-6">
              <h3 className="text-lg font-semibold text-black">Magang</h3>
              <p className="mt-4 text-base text-gray-600">
                Saat saya menjalani magang di Badan Pertanahan Nasional (BPN)
